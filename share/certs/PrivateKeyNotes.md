...
unlocked to sign the JWC-QT.app bundle.
...
allowing somebody to distribute a JWC-QT.app or JWC-qt-setup.exe with a valid
...
that the JWC-qt.exe file inside the installer had not been tampered with.
